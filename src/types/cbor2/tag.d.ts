import { e as RequiredCommentOptions, R as RequiredDecodeOptions, j as ToCBOR, a as Decodeable, T as TagNumber } from './options-QQFLweAY.js';
import './sorts.js';
...
declare class Tag implements ToCBOR, Decodeable {
     ...
     */
    static clearDecoder(tag: number): TagDecoder | undefined;
    /**
