...
This library is distributed in both **ESM (ECMAScript Module)** and **CommonJS (CJS)** formats.
...
- **ESM**: Recommended for modern environments.
- **CJS**: Provided for compatibility with legacy systems.

### CBOR2 Integration

The library uses a bundled version of [CBOR2](https://github.com/hildjj/cbor2) to ensure consistent handling of CBOR tags across ESM and CJS modules.
